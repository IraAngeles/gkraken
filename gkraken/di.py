...
class ProviderModule(Module):
    ...
    @provider
    def provide_kraken_two_driver(self) -> Optional[KrakenX3]:
        _LOG.debug("provide KrakenX3")
        return next((dev for dev in find_liquidctl_devices() if isinstance(dev, KrakenX3)), None)
